    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idenseignant', models.ForeignKey(blank=True, db_column='IDEnseignant', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='classroom_reservation_app.enseignants')),
                ('idetudiant', models.ForeignKey(blank=True, db_column='IDEtudiant', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='classroom_reservation_app.etudiants')),
                ('idsalle', models.ForeignKey(db_column='IDSalle', on_delete=django.db.models.deletion.DO_NOTHING, to='classroom_reservation_app.salle')),
            ],
        ),
        migrations.CreateModel(
